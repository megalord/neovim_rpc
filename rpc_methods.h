...
bool nvim_buf_set_var (Buffer buffer, char *name, void *value, uint32_t size) {
...
bool nvim_buf_set_option (Buffer buffer, char *name, void *value, uint32_t size) {
...
bool nvim_tabpage_set_var (Tabpage tabpage, char *name, void *value, uint32_t size) {
...
bool nvim_ui_set_option (char *name, void *value, uint32_t size) {
...
bool nvim_set_var (char *name, void *value, uint32_t size) {
...
bool nvim_set_option (char *name, void *value, uint32_t size) {
...
bool nvim_win_set_var (Window window, char *name, void *value, uint32_t size) {
...
bool nvim_win_set_option (Window window, char *name, void *value, uint32_t size) {
